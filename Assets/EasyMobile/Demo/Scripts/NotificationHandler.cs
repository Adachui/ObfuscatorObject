...
namespace EasyMobile.Demo
{
    public class NotificationHandler : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            Notifications.LocalNotificationOpened += NotificationManager_LocalNotificationOpened;
            Notifications.RemoteNotificationOpened += NotificationManager_PushNotificationOpened;
        }
        ...
        void NotificationManager_LocalNotificationOpened(LocalNotification delivered)
        {
            DisplayNotification(delivered, false);
        }

        // Push notification opened handler
        void NotificationManager_PushNotificationOpened(RemoteNotification delivered)
        {
